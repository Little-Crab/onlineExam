    ...
    <div class="login-main">
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div class="item layui-input-inline">
                    <select name="identitytype" lay-filter="shenfen">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg" src="captcha"
