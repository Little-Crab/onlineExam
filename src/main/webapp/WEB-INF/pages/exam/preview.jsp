...
<div class="layuimini-container bg"
     style="position: absolute;bottom: 0px;top: 40px;background-color: #F2F2F2;left: 0px;right:0px;margin: 10px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <c:if test="${question.type==1}">
                                                            <input type="radio" name="r${question.id}">
                                                        </c:if>
                                                        <c:if test="${question.type==2}">
                                                            <input type="checkbox" name="r${question.id}">
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                            ${option.opt}
