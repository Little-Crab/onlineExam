                                    ...
                                    <c:forEach items="${question.options}" var="option">
                                        <li>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <c:if test="${question.type == 1}"><input class="myselect"
                                                                                                  type="radio"
                                                                                                  name="r${question.id}"
                                                                                                  value="${option.id}"></c:if>
                                                        <c:if test="${question.type == 2}"><input class="myselect"
                                                                                                  type="checkbox"
                                                                                                  name="r${question.id}"
                                                                                                  value="${option.id}"></c:if>
                                                    </td>
...
<script>
    layui.use(['jquery', 'layer', 'util', 'laydate'], function () {
        let $ = layui.jquery, layer = layui.layer, util = layui.util, laydate = layui.laydate;
