                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="majorId" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">专业名称</label>
                            <div class="layui-input-inline">
                                <input type="text" name="majorName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                       <%-- <div class="layui-inline">
    ...
    layui.use(['form', 'table', 'tableSelect'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'majorId', width: 100, title: 'ID', sort: true},
                {field: 'majorName', width: 180, title: '姓名'},
                {field: 'deptName', width: 180, title: '所属学院', templet: "<div>{{d.department.deptName}}</div>"},
            ]],
